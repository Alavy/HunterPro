...
namespace Algine
{
    public class WeaponEditor : EditorWindow
    {
        ...
        WeaponSetting weaponSettingInstance;
        ...
        void OnGUI()
        {
            ...
            else if (toolbarInt == 1)
            {
                ...
                if (weapon != null)
                {
                    ...
                    if (GUILayout.Button("Create helpers for weapon"))
                    {
                        ...
                        weapon.GetComponent<Weapon>().MuzzleTransform = MuzzleFlashTransform.transform;
            ...
            else if (toolbarInt == 3)
            {
                ...
                if (weapon != null)
                {
                    ...
                    else
                    {
                        ...
                        {
                            WeaponSetting weaponSetting = new WeaponSetting();
                            AssetDatabase.CreateAsset(weaponSetting, "Assets/DarkTree FPS/WeaponData/" + weapon.name + " settings.asset");
                            weaponSettingInstance = (WeaponSetting)AssetDatabase.LoadAssetAtPath("Assets/DarkTree FPS/WeaponData/" + weapon.name + " settings.asset", typeof(WeaponSetting));
            ...
            else if(toolbarInt == 5)
            {
                ...
                if (GUILayout.Button("Create weapon pickup"))
                {
                    ...
                    _weaponPickupObject.GetComponent<WeaponPickup>().WeaponName = weaponNameToPickup;
                    _weaponPickupObject.GetComponent<WeaponPickup>().AmmoCount = weaponPickupAmmoCount;
